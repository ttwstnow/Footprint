...
dt <- fread("C:/Users/walid_000/Desktop/shinycoun/countries.csv", encoding = "UTF-8")
...
world.map <-readOGR("C:/Users/walid_000/Desktop/shinycoun/world borders/TM_WORLD_BORDERS-0.3.shp", 
...
header <-  dashboardHeader(
  ...
  , dropdownMenu(messageItem(from = "Github", message = "Click for application code"),
...
sidebar <-  dashboardSidebar(
  width = 250,
  sidebarMenu(menuItem("Menu",icon = icon("chevron-down"))),
  sidebarMenu(menuItem("Explore Data", tabName = "explore", icon = icon("search"),
                       menuSubItem("Maps", tabName="maps"),
                       menuSubItem("Descriptive statistics", tabName = "stats"))),
  sidebarMenu(menuItem("Data analysis", tabName = "analyse", icon = icon("bar-chart"),
  ...
  sidebarMenu(menuItem("Modeling", tabName = "modeling", icon = icon("line-chart"),
